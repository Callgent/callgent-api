...
export class AppController {
  ...
  postHello(@Body() body: any): string {
    ...
    const postmarkapp_com = {
      ...
      To: '"ddsfskldfjds+334rfgg@my.callgent.com" <ddsfskldfjds+334rfgg@my.callgent.com>',
      ToFull: [
        {
          Email: 'ddsfskldfjds+334rfgg@my.callgent.com',
          Name: 'ddsfskldfjds+334rfgg@my.callgent.com',
          MailboxHash: '334rfgg',
        },
      ],
      Cc: '',
      ...
      Bcc: '',
      BccFull: [],
      OriginalRecipient: 'ddsfskldfjds+334rfgg@my.callgent.com',
      Subject: 'Re: sfddsf',
      ...
      Headers: [
        ...
        { Name: 'Mime-Version', Value: '1.0' },
        {
          ...
          Value: '<lba+165e1ea30+c7f73a+my.callgent.com+pang.ju@roles.chat>',
        },
      ],
      Attachments: [],
    };
